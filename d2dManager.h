...
public:
	...
	void fillDrawRectangle(COLORREF lineRgb,COLORREF fillRgb, D2D_RECT_F rc);
	void fillDrawRectangle(COLORREF lineRgb, COLORREF fillRgb, float left, float top, float right, float bottom);
