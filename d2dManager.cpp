...
void d2dManager::fillDrawRectangle(COLORREF lineRgb, COLORREF fillRgb, D2D_RECT_F rc)
{
	D2D1_RECT_F rcf = getDrawRectfArea(rc.left, rc.top, rc.right, rc.bottom);
	...
	_renderTarget->FillRectangle(rcf, createBrush(fillRgb, 1));
	_renderTarget->DrawRectangle(rcf, createBrush(lineRgb, 1), 1);
}

void d2dManager::fillDrawRectangle(COLORREF lineRgb, COLORREF fillRgb, float left, float top, float right, float bottom)
{
	D2D1_RECT_F rcf = getDrawRectfArea(left, top, right, bottom);
...
void d2dManager::fillRectangle(COLORREF rgb, float startX, float startY, float endX, float endY , float opacity)
{
	D2D1_RECT_F rcf = getDrawRectfArea(startX, startY, endX, endY);
