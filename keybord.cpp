...
void keybord::imageInit()
{
	IMAGEMANAGER->addFrameImage("keybord", L"images/monster/boss/coralriff/coralriff_keytar.png", 208, 220, 4, 2);
	_img = IMAGEMANAGER->findImage("keybord");

	KEYANIMANAGER->addAnimationType("keybord");

	int stand[] = { 0,1,2,3 };
	KEYANIMANAGER->addArrayFrameAnimation("keybord", "keybord_Stand", "keybord", stand, 4, ANIMATION_FPS, true);

	int shadow[] = { 4,5,6,7 };
	KEYANIMANAGER->addArrayFrameAnimation("keybord", "keybord_Shadow", "keybord", shadow, 4, ANIMATION_FPS, true);

	_ani = KEYANIMANAGER->findAnimation("keybord", "keybord_Stand");
	_ani->start();
