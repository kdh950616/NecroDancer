...
void horn::imageInit()
{
	IMAGEMANAGER->addFrameImage("horn", L"images/monster/boss/coralriff/coralriff_horns.png", 288, 232, 4, 2);
	_img = IMAGEMANAGER->findImage("horn");

	KEYANIMANAGER->addAnimationType("horn");

	int stand[] = { 0,1,2,3 };
	KEYANIMANAGER->addArrayFrameAnimation("horn", "horn_Stand", "horn", stand, 4, ANIMATION_FPS, true);

	int shadow[] = { 4,5,6,7 };
	KEYANIMANAGER->addArrayFrameAnimation("horn", "horn_Shadow", "horn", shadow, 4, ANIMATION_FPS, true);

	_ani = KEYANIMANAGER->findAnimation("horn", "horn_Stand");
	_ani->start();
